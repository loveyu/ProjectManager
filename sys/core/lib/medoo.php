	...
	public function __construct($options){
		try{
			...
			switch($type){
				case 'mysql':
				case 'pgsql':
					$this->pdo = new PDO($type . ':host=' . $this->server . ';' . $port . 'dbname=' . $this->database_name, $this->username, $this->password, $this->option);
					break;
				...
				case 'sqlite':
					$this->pdo = new PDO($type . ':' . $this->database_file, $this->option);
					break;
				default:
